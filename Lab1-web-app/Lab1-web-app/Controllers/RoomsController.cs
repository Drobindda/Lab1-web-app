...
namespace Lab1_web_app.Controllers
{
    public class RoomsController : Controller
    {
        ...
        {
            var dBBookingContext = _context.Rooms.Include(r => r.Accomodation).Include(r => r.MealService).Include(r => r.Status);
        ...
        public async Task<IActionResult> Create([Bind("Id,AccomodationId,Name,SdandartOccupancy,MaxOccupancy,TotalBedrooms,TotalBathrooms,HasTv,HasKitchen,HasAirCon,HasInternet,MealServiceId,Description,Size,Price,Quantity,StatusId")] Room room)
        {
